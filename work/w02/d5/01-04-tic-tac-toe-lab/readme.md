...
Commit the code to a repo and push to your personal GitHub account.

Provide the repo's link by replying to the slack message sent by your instructors requesting it.
