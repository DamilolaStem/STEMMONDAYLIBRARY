...
- Write an `if` statement that logs the following message:<br>**"The score of [score] is the letter grade of [A, B, C, D or F]"**

- **Hint**: The `prompt` function returns a string which doesn't work well for the type of comparisons you'll want to make.
